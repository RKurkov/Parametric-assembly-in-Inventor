...
// ClampingJaws.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CClampingJawsApp, CWinApp)
...
CClampingJawsApp::CClampingJawsApp()
{
...
// Единственный объект CWSCADApp

CClampingJawsApp theApp;


// инициализация CWSCADApp

BOOL CClampingJawsApp::InitInstance()
{
